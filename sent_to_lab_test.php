...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-800" style="color: #9E5E31; margin-left: 38%;">Sample Sent To Lab</h1>


<!-- DataTales Example -->
<div class="card shadow mb-4 " style="margin-top: 20px;">
        <div class="card-header py-3" style="background-color: #F5E3A6;">
            <h6 class="m-0 font-weight-bold text" style="color: #b17f4ac9;">Sample sent to lab Information</h6>
        </div>
...
<!-- php of table -->
<?php
$query=mysqli_query($link, "SELECT tr.order_number,p.full_name,p.mobile_number,tr.test_type,tr.test_time_slot,tr.registration_date,tr.id AS test_id FROM test_record tr JOIN patients p ON p.mobile_number = tr.patient_mobile_number WHERE report_status like 'Sent to lab';");
$count = 1;
