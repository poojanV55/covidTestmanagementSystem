...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-800" style="color:#9E5E31; margin-left:38%;" >Assigned To Phlebotomist</h1>
...
<!-- php of table -->
<?php
$query=mysqli_query($link, "SELECT tr.order_number,p.full_name,p.mobile_number,tr.test_type,tr.test_time_slot,tr.registration_date,tr.id AS test_id FROM test_record tr JOIN patients p ON p.mobile_number = tr.patient_mobile_number WHERE report_status like 'On the way for sample collection';");
$count = 1;
